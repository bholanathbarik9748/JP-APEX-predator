...
//  JPApex
//
//  Created by Bholanath Barik on 06/04/24.
//
...
#Preview {
    NavigationStack {
        PredatorDetails(predator: Predators().allApexPredators[2], position: .camera(MapCamera(centerCoordinate: Predators().apexPredators[2].location, distance: 30000)))
